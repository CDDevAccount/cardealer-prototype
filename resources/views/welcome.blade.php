...
<div itemscope itemtype="http://schema.org/AutoDealer" id="wrapper">
    ...
    <div id="main-wrap">
        <div id="hometext" class="hideme">
            <h1>Cardealer Media Offer Services</h1>
            <h2>Quality cars from Quality dealers.</h2>
            <p>If you are looking for great savings on quality used cars nationwide, then you
                have reached the right place. We stock used cars from all dealers to suit all budgets
        ...
        <div class="row">
            <div class="main twelvecol">
                <div class="row-block html1">
                    <div class="hero-unit">
                        <div class="hero-unit__heading">Thousands of cars sold daily </div>
                    </div>
                    ...
                    <div class="reviews-overlay">
                        <a href="#" title="Over 800 Customer Experience Rating">Over 800 Customer Experience Rating</a>
                ...
                <div class="row-block row-block--car-carousel">
                    <div class="wrapper">
                        <div class="container">
                            <div class="section-heading">
                                <h2 class="section-heading__heading">Latest Cars</h2>
    ...
    <div class="footer__bottom">
        ...
        <div class="flex-center position-ref full-height">
            ...
            <div class="content">
                            ...
                            <div class="links">
                                <a href="/used-cars/">Cars</a>
                                <a href="/used-cars/norwich">Norwich Cars</a>
                                <a href="/used-cars/norwich/volkswagen">Norwich VW Cars</a>
